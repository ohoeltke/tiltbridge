...
#elif defined(LCD_TFT) && defined(CYD32)
// Configuration class for 3.2" CYD (ESP32-2432S032R) with ST7789 driver
// ST7789 320x240 on HSPI, XPT2046 touch on VSPI
class LGFX_CYD32 : public lgfx::LGFX_Device
{
...
public:
    LGFX_CYD32(void)
    {
...

        {
            ...
            cfg.dummy_read_bits = 1;
            cfg.readable = true;
            cfg.invert = true;  // ST7789 typically needs color inversion
            cfg.rgb_order = false;
            cfg.dlen_16bit = false;
            cfg.bus_shared = false;
            _panel_instance.config(cfg);
...

        {
            ...
            cfg.pin_bl = 27;  // 3.2" CYD uses GPIO 27 (2.8" uses GPIO 21)
            cfg.invert = false;
            cfg.freq = 44100;
            cfg.pwm_channel = 7;
